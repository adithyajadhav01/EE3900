...
Xz = Xz/10
ans1 = 10/89
if(np.allclose(Xz,ans1)): 
    print("option-2 is correct")
else : 
    print("option-2 is incorrect")
...
Yz = Yz/10
ans2 = 8/89
if(np.allclose(Yz,ans2)): 
    print("option-4 is correct")
else : 
    print("option-4 is incorrect")