...
Download the following Python code that plots Fig. \ref{fig-3.8}.
	\begin{lstlisting}
		wget https://github.com/adithyajadhav01/EE3900/blob/main/FOURIER/Codes/3.8.py
	\end{lstlisting}
...
\begin{figure}[!ht]
    \includegraphics[width=\columnwidth]{FIGURES/3.8.png}
...
Download the following Python code that plots Fig. \ref{fig-3.9}.
	\begin{lstlisting}
		wget https://github.com/adithyajadhav01/EE3900/blob/main/FOURIER/Codes/3.9.py
	\end{lstlisting}
	...
	\end{lstlisting}
\begin{figure}[!ht]
    \includegraphics[width=\columnwidth]{FIGURES/3.9.png}
...
Download the following Python code that plots Fig. \ref{fig-3.10}.
	\begin{lstlisting}
		wget https://github.com/adithyajadhav01/EE3900/blob/main/FOURIER/Codes/3.10.py
	\end{lstlisting}
